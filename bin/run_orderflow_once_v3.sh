...
OUT="${ORDERHEATMAP_V3_OUT:-$ROOT/artifacts/orderflow_chart_v3.png}"
HOURS="${ORDERHEATMAP_V321_HOURS:-${ORDERHEATMAP_V3_HOURS:-24}}"
mkdir -p "$ROOT/artifacts" "$ROOT/logs"
"$PACK/run_plot_v3.sh" "$DATA_DIR" "$OUT" "$HOURS" "$ABS_CFG"
