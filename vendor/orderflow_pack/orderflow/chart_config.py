...
FIG_WIDTH = 12.8
FIG_HEIGHT = 8.0
FIG_WIDTH_MULTIPLIER = 1.0
FIG_HEIGHT_MULTIPLIER = 1.0
FIG_HEIGHT_RATIO_MAIN = 6.6
FIG_HEIGHT_RATIO_OI = 1.35
BG_COLOR = "#151515"
TITLE_FONTSIZE = 13
...
GRIDSPEC_WIDTH_RATIOS_WITH_BAR = [0.08, 4.0, 0.30]
